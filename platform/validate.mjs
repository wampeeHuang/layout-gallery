 ...
 *
 * 用法:
 *   node platform/validate.mjs <slug>           # 校验单个模板
 *   node platform/validate.mjs --all             # 校验所有有 tokens.json 的模板
 *   node platform/validate.mjs <slug> --strict   # 严格模式: 也检查旧 brand.json+layout.json
 */
...
function main() {
  ...
  if (slugs.length === 0) {
    console.error('Usage: node platform/validate.mjs <slug> [--strict]');
    console.error('       node platform/validate.mjs --all');
    process.exit(1);
  }
